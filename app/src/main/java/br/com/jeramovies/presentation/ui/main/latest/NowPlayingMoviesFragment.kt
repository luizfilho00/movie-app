package br.com.jeramovies.presentation.ui.main.latest
...
class NowPlayingMoviesFragment : Fragment() {
    ...
    private fun setupUi() {
        with(binding.recyclerView) {
            adapter = this@NowPlayingMoviesFragment.adapter
    ...
    private fun subscribeUi() {
        with(viewModel) {
            nowPlayingMovies.observe(viewLifecycleOwner, ::onMoviesReceived)
